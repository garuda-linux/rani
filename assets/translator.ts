...
// actual humans, therefore we should not touch them with this script.
const mainLang = 'en';
...
const i18nPaths: string[] = ['assets/i18n'];
...
async function main(): Promise<void> {
  const askFor = `
    You are the translator of an the website for an Archlinux-based Linux distribution called Garuda Linux.
