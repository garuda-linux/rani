  ...
  template: ` <p-fieldset [toggleable]="true" legend="General">
    ...
    <section class="grid grid-cols-4 mb-3 gap-2">
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.transitionDuration"
          label="Transition Duration"
        />
      </div>
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.disabledOpacity"
          label="Disabled Opacity"
        />
      </div>
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.iconSize"
          label="Icon Size"
        />
      </div>
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.anchorGutter"
          label="Anchor Gutter"
        />
      </div>
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.content.borderRadius"
          label="Border Radius"
        />
      </div>
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.mask.transitionDuration"
    ...
    <section class="grid grid-cols-4 gap-2">
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.focusRing.width"
          label="Width"
        />
      </div>
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.focusRing.style"
          label="Style"
        />
      </div>
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.focusRing.color"
          [type]="'color'"
          label="Color"
        />
      </div>
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.focusRing.offset"
          label="Offset"
        />
      </div>
    </section>
