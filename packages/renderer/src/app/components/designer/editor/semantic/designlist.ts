  ...
  template: ` <p-fieldset [toggleable]="true" legend="List">
    ...
    <section class="grid grid-cols-4 mb-3 gap-2">
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.list.padding"
          label="Padding"
        />
      </div>
      <div class="flex flex-col gap-1">
      ...
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.list.header.padding"
    ...
    <section class="grid grid-cols-4 mb-3 gap-2">
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.list.option.padding"
          label="Padding"
        />
      </div>
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.list.option.borderRadius"
          label="Border Radius"
        />
      </div>
    </section>
    ...
    <section class="grid grid-cols-4 gap-2">
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.list.optionGroup.padding"
          label="Padding"
        />
      </div>
      <div class="flex flex-col gap-1">
        <design-token-field
          [(modelValue)]="designerService.designer().theme.preset.semantic.list.optionGroup.fontWeight"
          label="Font Weight"
        />
      </div>
    </section>
