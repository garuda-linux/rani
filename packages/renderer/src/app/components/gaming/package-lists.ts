...
export const gamingPackageLists: PackageSections = [
  {
    ...
    sections: [
      ...
      { name: 'Itch', pkgname: ['itch-setup-bin'], icon: 'itch.svg' },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'Luxtorpeda', pkgname: ['luxtorpeda-bin'], icon: 'proton.svg' },
      {
      ...
      },
      {
        name: 'ProtonUp-Qt',
        pkgname: ['protonup-qt'],
        icon: 'protonup-qt.png',
      },
      {
        name: 'WINE Meta',
        pkgname: ['wine-meta'],
        icon: 'winehq.png',
        description: 'gaming.wineMeta',
      },
      { name: 'WINE', pkgname: ['wine'], icon: 'winehq.png' },
      {
        name: 'WINE WOW64',
        pkgname: ['wine-wow64'],
        icon: 'winehq.png',
        description: 'gaming.wineWow64',
      },
      { name: 'WINE Staging', pkgname: ['wine-staging'], icon: 'winehq.png' },
      {
        name: 'WINE Staging WOW64',
        pkgname: ['wine-staging-wow64'],
        icon: 'winehq.png',
        description: 'gaming.wineStagingWow64',
      },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'AnyDesk', pkgname: ['anydesk-bin'], icon: 'anydesk.svg' },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'RetroArch', pkgname: ['retroarch'], icon: 'libretro.png' },
      { name: 'MAME', pkgname: ['mame'], icon: 'generic-dark.svg' },
      {
        name: 'Mandarine (Citra)',
        pkgname: ['mandarine-git'],
        icon: 'mandarine.svg',
      },
      { name: 'Mednafen', pkgname: ['mednafen'], icon: 'generic-dark.svg' },
      { name: 'Nestopia', pkgname: ['nestopia-git'], icon: 'nestopia.png' },
      { name: 'PCSX2', pkgname: ['pcsx2-git'], icon: 'pcsx2.png' },
      ...
      { name: 'RPCS3', pkgname: ['rpcs3-git'], icon: 'rpcs3.png' },
      ...
      { name: 'mGBA', pkgname: ['mgba-qt'], icon: 'mgba.png' },
    ],
  },
];
