...
export const gamingPackageLists: PackageSections = [
  {
    ...
    sections: [
      ...
      { name: 'Heroic Games Launcher', pkgname: ['heroic-games-launcher-bin'], icon: 'heroic-icon.png', description: 'gaming.heroic' },
      ...
      { name: 'Steam (native)', pkgname: ['steam-native-runtime'], icon: 'steam.png', description: 'gaming.steamNative' },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'ProtonGE-Custom', pkgname: ['proton-ge-custom-bin'], icon: 'proton-ge-custom.png', description: 'gaming.protonGeCustom' },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'Gamemode', pkgname: ['gamemode', 'lib32-gamemode'], icon: 'generic-dark.svg', description: 'gaming.gamemode' },
      { name: 'Gamescope session (Steam)', pkgname: ['gamescope-session-steam-git'], icon: 'steam.png', description: 'gaming.gamescopeSessionSteam' },
      { name: 'Gamescope session', pkgname: ['gamescope-session-git'], icon: 'valve.png', description: 'gaming.gamescopeSession' },
      ...
      { name: 'MangoHud', pkgname: ['mangohud', 'lib32-mangohud'], icon: 'mangohud.png', description: 'gaming.mangohud' },
      { name: 'SteamTinkerLaunch', pkgname: ['steamtinkerlaunch'], icon: 'steam.png', description: 'gaming.steamtinkerlaunch' },
      { name: 'VR video player', pkgname: ['vr-video-player'], icon: 'generic-dark.svg', description: 'gaming.vrVideoPlayer' },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'Game Conqueror', pkgname: ['gameconqueror'], icon: 'generic-dark.svg', description: 'gaming.gameconqueror' },
      { name: 'Input remapper', pkgname: ['input-remapper-git'], icon: 'generic-dark.svg', description: 'gaming.inputRemapper' },
      { name: 'Keyboard visualizer', pkgname: ['keyboard-visualizer-git'], icon: 'generic-dark.svg', description: 'gaming.keyboardVisualizer' },
      ...
      { name: 'Polychromatic', pkgname: ['polychromatic'], icon: 'polychromatic_green.svg', description: 'gaming.polychromatic' },
      { name: 'Sc-controller', pkgname: ['sc-controller'], icon: 'generic-dark.svg', description: 'gaming.scController' },
      { name: 'SoundWire', pkgname: ['soundwire'], icon: 'soundwire.png', description: 'gaming.soundwire' },
      { name: 'StreamLink Twitch GUI', pkgname: ['streamlink-twitch-gui-bin'], icon: 'streamlink-twitch.png', description: 'gaming.streamlinkTwitchGui' },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'Xbox One dongle', pkgname: ['xone-dongle-firmware'], icon: 'xone.svg', description: 'gaming.xoneDongleFirmware' },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'Emulationstation', pkgname: ['emulationstation'], icon: 'es.ico', description: 'gaming.emulationstation' },
      ...
      { name: 'Libretro (all cores)', pkgname: ['libretro-meta'], icon: 'libretro.png', description: 'gaming.libretroMeta' },
      ...
      { name: 'Mandarine (Citra)', pkgname: ['mandarine-git'], icon: 'mandarine.svg', description: 'gaming.mandarine' },
      ...
      { name: 'Pegasus frontend', pkgname: ['pegasus-frontend-git'], icon: 'generic-dark.svg', description: 'gaming.pegasusFrontend' },
