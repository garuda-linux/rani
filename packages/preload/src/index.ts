...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  log: {
    ...
    withContext: (level: string, message: string, context: Record<string, unknown>) =>
...
export { sha256sum, versions, send, shellSpawnStreaming, shellWriteStdin, shellKillProcess };
