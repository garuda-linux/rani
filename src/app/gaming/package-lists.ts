...
export const gamingPackageLists: GamingSections = [
  {
    ...
    sections: [
      ...
      { name: 'Heroic Games Launcher', pkgname: ['heroic-games-launcher-bin'], icon: 'heroic-icon.png' },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'Protontricks', pkgname: ['protontricks-git'], icon: 'proton.svg' },
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'Input remapper', pkgname: ['input-remapper-git'], icon: 'generic-dark.svg' },
      { name: 'Keyboard visualizer', pkgname: ['keyboard-visualizer-git'], icon: 'generic-dark.svg' },
      ...
      { name: 'StreamLink Twitch GUI', pkgname: ['streamlink-twitch-gui-bin'], icon: 'streamlink-twitch.png' },
